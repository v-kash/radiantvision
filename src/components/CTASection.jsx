  ...
  return (
    <section className="relative py-16 px-[8%] bg-[#1a1f16] overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          {/* PRIMARY CTA */}
          <button className="group relative inline-flex items-center gap-3 overflow-hidden px-8 py-3 text-sm tracking-wide text-white font-medium rounded-[2px]">
            {/* GRADIENT BASE */}
          ...
          {/* SECONDARY CTA */}
          <button className="group relative px-8 py-3 text-sm tracking-wide text-white rounded-[2px] border border-white/10 hover:border-[#5a7a4a]/40 transition">
            {/* HOVER BG */}
