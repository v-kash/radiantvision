...
const industries = [
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-6 h-6">
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 21h18M3 10.5V21M21 10.5V21M6 21V10.5M10.5 21V10.5M13.5 21V10.5M18 21V10.5M3 10.5L12 3l9 7.5" />
      </svg>
    ),
    title: "Commercial & Office Buildings",
    desc: "High-performance MEP for corporate towers and mixed-use spaces.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-6 h-6">
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955a1.5 1.5 0 012.092 0L21.75 12M4.5 9.75V21a.75.75 0 00.75.75h4.5a.75.75 0 00.75-.75v-4.5a.75.75 0 01.75-.75h3a.75.75 0 01.75.75V21a.75.75 0 00.75.75h4.5a.75.75 0 00.75-.75V9.75" />
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-6 h-6">
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17L4.655 7.926a2.25 2.25 0 010-3.182l.92-.92a2.25 2.25 0 013.182 0l6.29 6.29" />
      </svg>
    ),
    title: "Industrial & Manufacturing",
    desc: "Robust, scalable MEP infrastructure for heavy-duty operations.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-6 h-6">
    ...
    <section className="py-24 bg-white overflow-hidden">
      ...
      <div className="text-center mb-16 px-[8%]">
        ...
        <p className="max-w-xl mx-auto text-[#777] text-base">
          From corporate towers to critical healthcare facilities — our expertise
